...
distinct_colours = st.sidebar.toggle("Colour warehouses uniquely", value=True, help="Turn off to show all facilities in the same colour",)
...
if up_file is not None:
    ...
    plot_network(stores, centers, distinct_colours=distinct_colours)
